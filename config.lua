...
Config.Fire = {
    ...
    maximumSpreads = 5,
    difficulty = nil, -- Sets how hard (lengthy) it will be to extinguish a fire (set nil as default or a whole number larger than 0, e.g. 2, to increase difficulty; try how it works, don't use numbers higher than 10)
